...
public:
    ...
    virtual bool createRow(const QString& tableName,const QString& fullname, const QString& id, const QJsonObject& jsonObject) const = 0;
    ...
    virtual QJsonArray viewClients() const = 0;
    ...
    virtual void delSeat(const QString& plane,const QString& value) = 0;
    virtual void addSeat(const QString& plane,const QString& value) = 0;
