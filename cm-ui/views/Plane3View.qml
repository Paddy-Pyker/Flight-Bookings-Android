...
Item {
    ...
    property ThirdPlane plane: masterController.ui_databaseController.ui_thirdPlane
    ...
    Rectangle {
        ...
        Rectangle{
            ...
            Button{
                ...
                onClicked:{
                    ...
                    if (masterController.ui_databaseController.ui_thirdPlane.ui_checkSA)
                    {
                        planeName.ui_value="Mil Mi-8"
        ...
        Rectangle{
            ...
            GridView{
                ...
                model: basegroup.listSort(masterController.ui_databaseController.ui_thirdPlane.ui_RESERVED)
                delegate: Text {
        ...
        Rectangle{
            ...
            GridView{
                ...
                model: basegroup.listSort(masterController.ui_databaseController.ui_thirdPlane.ui_AVAILABLE)
                delegate:
                    Text {
