...
Item {
    ...
    property SecondPlane plane: masterController.ui_databaseController.ui_secondPlane
    ...
    Rectangle {
        ...
        Rectangle{
            ...
            Button{
                ...
                onClicked:{
                    ...
                    if (masterController.ui_databaseController.ui_secondPlane.ui_checkSA)
                    {
                        planeName.ui_value="Airbus A380"
        ...
        Rectangle{
            ...
            GridView{
                ...
                model: basegroup.listSort(masterController.ui_databaseController.ui_secondPlane.ui_RESERVED)
                delegate: Text {
        ...
        Rectangle{
            ...
            GridView{
                ...
                model: basegroup.listSort(masterController.ui_databaseController.ui_secondPlane.ui_AVAILABLE)
                delegate:
                    Text {
